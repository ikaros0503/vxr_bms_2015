define({
    ...
    start: function (o) {
        ...
        vdc.gD(o.data, function () {
            ...
            $('body').unbind('rlBKS').on('rlBKS', function () {
                me._reloadBks({});
            });
        });
    },
...
(function ($) {
    ...
    $.extend(true, $.custom.vbooking.prototype, {
        ...
        *************************************************************************/
        ...
        //            $('input[name=pIndex]').val(selectedSearchResult.attr('data-order'));
        ...
        //    if (type == 'transfer' && self._data[self._cTripIndex].TransferPointsInfo == null) return;
        //    if (type == 'pickup' && self._data[self._cTripIndex].PickedPointsInfo == null) return;
        ...
        //                        if (!$form.find("select[name=PaymentType]").attr('disabled')) {
        ...
        //    var self = this;
        //    app.suggestCustomer = data;
        //    app.totalSuggestCustomer = total;
        //},
        ...
        //    if (vIsEstStr(app.copyInfo["FromArea"])) {
        //        fromArea = app.copyInfo["FromArea"];
        //    }
        //    if (vIsEstStr(app.copyInfo["ToArea"])) {
        //        toArea = app.copyInfo["ToArea"];
        //    }
        //    var idInfo = [];
        //    var seatNo = [];
        //    var customerInfo = [];
        ...
        //            if (kn != "Code") {
        //                obj[kn] = app.copyInfo[kn];
        //            } else {
        //                var tripDetailIdOld = app.copyInfo["TripDetailId"] ? app.copyInfo["TripDetailId"] : 0;
        ...
        //    if (app.seatStack.length > 1) { //Multiple ticket
        ...
        //    var self = this;
        //    var data = {
        //        "payment": parseInt(self._$updateForm.find('select[name=PaymentType]').val()),
        ...
        //    var validateValue = function (condition) {
        //        var result = false;
        //        try {
        //            var source = data[condition];
        //            if (condition.indexOf('[') >= 0) {
        //                source = parseInt(data[condition.substring(0, condition.indexOf('['))]);
        //                if (condition.indexOf('[>=') >= 0) {
        //                    result = source >= parseInt(condition.substring(condition.indexOf('[>=') + 3).replace(']', ''));
        //                } else if (condition.indexOf('[<=') >= 0) {
        //                    result = source <= parseInt(condition.substring(condition.indexOf('[<=') + 3).replace(']', ''));
        //                } else if (condition.indexOf('[=') >= 0) {
        //                    result = source == parseInt(condition.substring(condition.indexOf('[=') + 2).replace(']', ''));
        //                } else if (condition.indexOf('[>') >= 0) {
        //                    if (data["payment"] != 9) { // không tính trường hợp vé VIP
        //                        result = source > parseInt(condition.substring(condition.indexOf('[>') + 2).replace(']', ''));
        //                    } else {
        //                        result = true;
        //                    }
        ...
        //            self._$updateForm.find('div.message-error').html(_dict._updateFormValidatingErrorMessages[errorField]);
        //        } else {
        ...
        *************************************************************************/
        ...
        //    app.copyInfo["TripDetailId"] = tripDetailId;
        ...
        *************************************************************************/
        ...
        //    obj._c = [];
        //    obj._d = [];
        //    var numOfCancel = app.seatStack.length;
        //    $.each(app.seatStack, function (i, v) {
        //        var t = v._getCurrentTicket();
        //        var cancelFee = 0;
        //        if (isPercent) {
