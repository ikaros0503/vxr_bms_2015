...
Pager.prototype.render= function() {
    ...
    $(self.container + " ul.pages li a").unbind().on("click", function() {
    ...
    $(self.container + " div.pager-info select.allPages").unbind().on("change", function () {
    ...
    $(self.container + " div.pager-info select.itemsPerPage").unbind().on("change", function () {
	    self.currentPage = 1;
