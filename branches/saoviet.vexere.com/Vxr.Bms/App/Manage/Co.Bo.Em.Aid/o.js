define({
    title: 'Quản lý phụ xe', name: 'Phụ xe',
    grid: true, gTitle: 'Danh sách phụ xe', gId: 'assistantTableContainer', //gRights: 41,
    xWidth: '', cols: 4, winCls: 'phuxe', useSmCls: true, autoClear: true,
    ...
    queryConditions: (app.cid == app.vid) ?
        {
            IsPrgStatus: 1, Type: "$x=4 order by IsPrgUpdatedDate desc"
        } :
        {
            CompId: app.cid,
            IsPrgStatus: 1,
            Type: "$x=4 order by IsPrgUpdatedDate desc"
        },
    defaultData: { Type: 4, IsPrgStatus: 1, CompId: app.cid },
    ...
    buttons: [
        ...
        },
        {
            ...
            messSucc: 'Xóa phụ xe thành công.',
