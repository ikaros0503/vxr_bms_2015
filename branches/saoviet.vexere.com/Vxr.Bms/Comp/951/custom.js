//Extend dict
define({
    _pStyleUrl: "/Comp/951/print.css?v=1.0.54",
    _uForm: [
    "UpdateForm",
    [
    ...
    _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
          + "<tbody>"
          + "<tr style='height: 18px'><td><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p><p class='pmInfo ppayment {pseat._onlyPaidBackGround}'>{pseat._fare}</p></td></tr>"
          + "<tr class='thong'><td><p class='pcname'>{pseat._cname}&nbsp;{pseat._nTicketPerTrip}</p><p class='pcphone'> <b>{pseat._cphone}</b>&nbsp;<b class='ntk-pertrip'></b></p></td></tr>"
