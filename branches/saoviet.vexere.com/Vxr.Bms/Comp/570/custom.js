//Extend dict
define({
    _pStyleUrl: "/Comp/570/print.css?v=1.0.44",
    ...
    _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
              + "<tbody>"
             + "<tr style='height: 18px;'><td><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p><span class='fare' style='width=60%;float:right;'><b>{pseat._fare}</b></td></tr>"
             + "<td><p class='ppayment {pseat._paid} {pseat._exported}'>{pseat._stageName}</p></td>"
              + "<tr><td><p class='pcname' style='text-align:left;width:100%;margin-top:-3px;white-space:nowrap'><span style='width=100%'>{pseat._cname}</span></span></p><p class='sdt' style='font-size:14px;'><b>{pseat._cphone}</b>&nbsp;<span class='ntk' style='font-size:13px'>{pseat._nTicketPerTrip}</p><p class='pnote'>{pseat._note}</p></td></tr>"
             + "</tbody>"
              + "</table></li>",
    ...
    _tripInfo: "<div style='margin-top:7px;float:left;width:100%;'>" +
               ...
               "<div style='float:right;width:100%;'>" +
                    "<table style='width:100%;' cellspacing='0'>" +
                        "<tbody>" +
                           "<tr style='height:40px;line-height: 24px;'>" +
