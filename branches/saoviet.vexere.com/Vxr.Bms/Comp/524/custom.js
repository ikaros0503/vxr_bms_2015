...
define({
    ...
    _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
          + "<tbody>"
          + "<tr style='height: 18px'><td><p class='pseat-code'>{pseat._label}</p><p class='pmInfo ppayment {pseat._onlyPaidBackGround} {pseat._dathanhtoan}'>{pseat._fare}</p></td></tr>"
          + "<tr class='thong'><td><p class='pcname'>{pseat._cname}</p><p class='pcphone'> <b>{pseat._cphone}</b>&nbsp;<b class='ntk-pertrip'></b></p></td></tr>"
          + "<tr><td><p class='stage'>{pseat._stageName} {pseat._nTicketPerTrip}</p></td></tr>"
    ...
    _pStyleUrl: "/Comp/508/print.css?v=1.0.49",
