...
namespace Vxr.Bms.Bu
{
    public class PS
    {
        ...
        public static string GetViewAsString(string[] h, string filePath)
        {
            ...
            temp.Replace("<%DepartureTime%>", h[6].ToString());
        ...
        {
            bool result = true;
            const String FROM = "DatVeOnline@vexere.org";
            ...
            const String SMTP_USERNAME = "AKIAITBXMORJI5LRSAUQ"; // Replace with your SMTP username. 
            const String SMTP_PASSWORD = "AnAR7pNNU3Ne7SXnMXbi+8nh02R3bVyQmieO+gGPjICR";
