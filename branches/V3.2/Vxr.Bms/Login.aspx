...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Base/jquery.realperson.package-2.0.1/jquery.realperson.css" />

    <link href="Styles/responsive/max-width-1023.css" rel="stylesheet" />
    <link href="Styles/responsive/max-width-767.css" rel="stylesheet" />
    <link href="Styles/responsive/max-width-479.css" rel="stylesheet" />
    <link href="Styles/responsive/max-width-319.css" rel="stylesheet" />

    <link href="Styles/more/login.min.css" rel="stylesheet" />
    <script>
        $(function () {
            $('.txtcapcha').realperson({ length: 3, regenerate: '' });
            $(".navbar-toggle").hide();
...
<body style="overflow-x:hidden;">
    ...
    <div class="nonSupport">
        <span>Thiết bị của bạn có màn hình quá nhỏ để sử dụng tính năng này, vui lòng chọn thiết bị khác, thân!</span>
        <br />
        <img src="Content/images/sad-face.png" />
    </div>

    <div class="container login-container" style="min-height: 360px;">
        <div class="row">
            <form id="LoginForm" class=" col-sm-offset-3 col-sm-6 col-md-4 col-md-offset-4" runat="server">
    ...
    <div class="footer">
        ...
        <div class="row info">
            <div class="col-md-12 col-xs-12"><span class="copyright"></span><span class="hotline"></span></div>
        </div>        
    </div>

    <script type="text/javascript" src="Base/jquery.realperson.package-2.0.1/jquery.plugin.js"></script>
    <script type="text/javascript" src="Base/jquery.realperson.package-2.0.1/jquery.realperson.js"></script>
</body>
</html>
