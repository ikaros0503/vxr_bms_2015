...
define({
    ...
    _updateTicket: function (f, stopPoints, tBus, tId, offsetMinute, tName, tDate, cb) {
        var me = this;
        var obj = me._createUpdateTicketObj(f, stopPoints, tBus, tId, offsetMinute, tDate);
        if (obj) {
            if (!obj._d) obj._d = [{}];
    ...
    _createUpdateTicketObj: function (f, stopPoints, tBus, tId, offsetMinute, tDate) {
        var me = this;
                ...
                $(b).unbind().on('click', function (e) {
                    ...
                    var cb = function () {
                        var afReload = function () {
                            vbf('onPrintETicketSave', { // print eticket
                                tId: tId,
                                tName: tName,
                                tDate: tDate,
                                cTrip: cTrip,
