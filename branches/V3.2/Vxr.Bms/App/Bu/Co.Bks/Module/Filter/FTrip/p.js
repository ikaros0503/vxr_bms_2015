...
$(document).ready(function () {
    ...
    $._createGetFrameObj = function (date) {
        ...
        var d = "(type = 1 or (type = 2 and Time is not null and $x = N'" + tripDate.toFormatString('iso') + "')) order by type, DisplayOrder, name asc";
        //Create 
        var obj = {};
        obj._a = "fGetTrip";
        obj._c = {
        ...
        obj._f = "Id, Name, Info, SeatTemplateInfo, FareInfo, StatusInfo, BaseId, Type, Time, " +
            "Alias, TeamInfo, VehicleInfo, FromArea, ToArea, Note, RouteInfo, SeatSummaryInfo," +
            " TotalSeats, ClosedStatus, PassengerMoney, ProductMoney, FeeMoney, " +
            "BranchReceiveProduct, RealDepartureTime, PickedPointsInfo, TransferPointsInfo, " +
            "NewFare, DisplayOrder, Description, TotalBookedSeats, TotalPaidSeats";
        return obj;
    }
});
