    ...
    *************************************************************************/
    ...
    _createTicketFromRecord: function (record) {
        ...
        if (alias == self._cTripBus) { //Alias
            ...
            sNote, responUser, porDate, staffName, cancelType, numOfSend, firstUserUpdated, expiredTime);
            re.agentId = record[2];
            return re;
        }
        return {};
...
var _dict = {
    _lang: "vi",
    _tgF: ["Id", "TripId", "AgentId", "TripDate", "SeatCode", "IssueDate", "PickupDate", "CustomerInfo", "Status", "Fare", "Note", "PickupInfo", "Serial", "PaymentInfo", "IsPrgHistoryInfo", "Code", "PassCode", "FromValid", "ToValid", "IsPrgUpdatedDate", "AgentInfo", "Surcharge", "TripAlias", "CreatedUser", "UserCharge", "StageCode", "Deposit", "Discount", "FromArea", "ToArea", "SeatType", "Debt", "CanceledDate", "CancelInfo", "Type", "ChargeDate", "SNote", "ResponsibilityUser", "PickOrReturnDate", "StaffName", "CancelType", "NumOfSend", "FirstUserUpdated", "ExpiredTime"],
