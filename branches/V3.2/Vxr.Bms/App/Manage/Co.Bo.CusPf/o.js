define({
    ...
    jVar: {
        ...
        getTripConditions_U: " CustomerId={id} and compId={compId} and Status!=3 and TripDate>'{date}' {dateFilter} ",
        getTripConditions_P: " CustomerId={id} and compId={compId} and Status!=3 and TripDate<='{date}' {dateFilter} ",
        getTripConditions_C: " CustomerId={id} and compId={compId} and Status=3 {dateFilter} ",
