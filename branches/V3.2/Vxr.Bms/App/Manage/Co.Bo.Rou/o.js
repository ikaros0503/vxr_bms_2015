define({
    ...
    baseCf: {
        ...
        _f: 'Id, Name, RouteInfo, FareInfo, Description'
    },
            ...
            items: [

                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'textbox', name: 'DisplayOrder', label: "Thứ tự vị trí hiển thị", ref: 'input.route-order', data: true,
                            form: true, fIdx: 1, cls: 'route-order', rights: '',
                        ...
                        },
                        {
                            ...
                            grid: false, gIdx: 80, gQuery: true
                        }
                    ]
                },
                {
                    ...
                    items: [
                        ...
                        {
                            name: 'Description', id: 'driver-info', ref: 'input.driver-info', data: true,
                            form: true, cls: 'driver-info', rights: '',
                            grid: false, gQuery: true, xtype: 'inputHidden01', gIdx: 50, fIdx: 500,
                        },
                        //{
                    ...
                    items: [
                        {
                            ...
                            items: [
                                
                                {
                                    ...
                                    form: true, fIdx: 3, flex: 1, cls: 'info', required: true, requiredCls: 'bdred', rights: '',
                                ...
                                {
                                    xtype: 'table001', id: 'driver-table', grid: false, gQuery: false, form: true, rights: '',
                                    cls: 'table mb0', notInRow: true, formToGridOnly: true,
