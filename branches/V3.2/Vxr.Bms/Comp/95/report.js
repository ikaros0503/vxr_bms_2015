...
var opt = {
    ...
    listReport: [
        //{ id: 1, name: 'Khách hàng theo chuyến', index: 1, value: 'rpCustomerByTrip', filter: rCustomerByTrip, typereport: '0,1,2', rightId: $.rights.rRp1.dtr },
        { id: 1, name: 'Khách hàng theo chuyến', index: 1, value: 'rpCustomerByTripForSapa', filter: rCustomerByTrip, typereport: '0,1,2', rightId: $.rights.rRp1.dtr },
		{ id: 2, name: 'Doanh thu nhân viên theo ngày bán vé', index: 2, value: 'rpStaffBySoldDate', filter: rFromToTripOfficeStaff, typereport: '0,1,2,3,4', rightId: $.rights.rRp2.dtr },
        { id: 3, name: 'Doanh thu nhân viên theo ngày khởi hành', index: 3, value: 'rpStaffByPickupDate', filter: rFromToTripOfficeStaff, typereport: '0,1,2,3,4', rightId: $.rights.rRp3.dtr },
        { id: 4, name: 'Doanh thu chi nhánh/ đại lý theo ngày bán vé', index: 4, value: 'rpAgentOrBranchBySoldDate', filter: rFromToTripOffice, typereport: '0,1,2,3', rightId: $.rights.rRp4.dtr },
        { id: 5, name: 'Doanh thu chi nhánh/ đại lý theo khởi hành', index: 5, value: 'rpAgentOrBranchByPickupDate', filter: rFromToTripOffice, typereport: '0,1,2,3', rightId: $.rights.rRp5.dtr },
        { id: 6, name: 'Doanh thu theo chuyến xe', index: 6, value: 'rpRevenueByTrip', filter: rRevenueByTrip, typereport: '0,1,2', rightId: $.rights.rRp6.dtr },
        { id: 7, name: 'Doanh thu theo tuyến', index: 7, value: 'rpRevenueByRoute', filter: rRevenueByRoute, typereport: '0,1,2', rightId: $.rights.rRp7.dtr },
        { id: 8, name: 'Doanh thu chi nhánh theo tuyến', index: 8, value: 'rpBranchByRoute', filter: rFromToTripOffice, typereport: '0,1,2,3', rightId: $.rights.rRp8.dtr }        
    ],
    wReport: 1,
