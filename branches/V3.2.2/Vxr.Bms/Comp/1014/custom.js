//Extend dict
define({
	 _pStyleUrl: "/Comp/1014/print.css?v=1.0.4",
	 // _specialPos: {
         // 47: {
             // "1_1_1": [1, 8, 5], 
    ...
    _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
          + "<tbody>"
          + "<tr style='height: 18px;'><td><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p><p class='gop' style='float: right;text-align: right;'><span><class ='ttPayment' style=''>{pseat._ttPayment}</span>&nbsp;<span><b class='ntk-pertrip'>{pseat._nTicketPerTrip}</b></span></p></td></tr>"
          + "<tr style='height: 22px;'><td><p class='pcphone' style='float: right;'><b>{pseat._cphone}</b></p></td></tr>"
          + "<tr><td><p class='pInfo' style=''>{pseat._pInfo}</p></td></tr>"
		  + "<tr><td><p class='pnote' style='clear:both;'>{pseat._note}</p></td></tr>"
          + "</tbody>"
          + "</table></li>",
	//header phoi
    _pTitleTpl: "<table class='print-title' style='float:right; width:830px;'><tbody><tr><td style=''><strong class='title' style='margin-left:80px;'>{p._title}</strong></td><td colspan='' style=''><strong class='rname'>{p._rname}</strong></td><td style=''>Số xe:&nbsp{p._busNum}</td></tr><tr><td style=''><span class ='c' style='margin-left: 80px;'>Chuyến:&nbsp;<strong class='time'>{p._time}</span></strong></td><td>Lái xe:&nbsp;{p._driverName}</td><td>Phục vụ:&nbsp;{p._assistantName}</td></tr></tbody></table>",
    ...
    _updateFormValidatingErrorMessages: {
        ...
        "fare": "Giá vé phải lớn hơn 0.",
			 ...
			 _hasMergeTransfer: { 109267: true, 109266: true },
        ...
        _pSNoteInfo: {
            46: {
                1: "<div style='position:relative;clear:both;margin-left:450px;'>" +
                        "<table cellpadding='0' cellspacing='0' border='0' width='250px' style='position:absolute;margin-top:-94px;margin-left:-449px;'>" +
                            "<tr>" +
                            ...
                            "</tr>" +
                           "<tr>" +
                                "<td style='line-height:30px;'><b>KH phát sinh:</b>....................<b></td>" +
                            "</tr>" +
                                        "</tbody>" +
                                    "</table>" +
                                "</td>" +
			...
			29: {
                1: "<div style='position:relative;clear:both;margin-left:450px;'>" +
                        "<table cellpadding='0' cellspacing='0' border='0' width='250px' style='position:absolute;margin-top:15px;margin-left:-449px;width:750px;'>" +
                            "<tr>" +
                                "<td style='line-height:30px;'><b>KH tại bến:....................................KH đón d.đường:....................................KH phát sinh:....................................</b></td>" +
                            "</tr>" +
