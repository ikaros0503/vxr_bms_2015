        ...
        "custom": {
            17001: {
                "sm": "<div style='width:459px; margin: 0 auto; padding-left: 0px;'><div class='col-xs-12 logonx' style='padding: 0 0 10px;font-weight: 700;font-size: 16px;'><p style='font-size:31px;padding:2px 0 0 0;font-family:initial;text-align:center;margin-bottom:0;'>PHIẾU ĐẶT CHỖ</p></div>"
                    ...
                    "<p style='float: left;width: 100%;text-align: left;'><icon style='font-size:23px;line-height:15px;height:17px;vertical-align: bottom; display:inline-block;'>&#8226;</icon>&nbsp;<i>Bx. Mỹ Đình xuất bến sớm hơn 1 giờ (giờ in trên vé là giờ xuất phát của Vp Trần Khát Trân).<i></p></div></div></div>",
