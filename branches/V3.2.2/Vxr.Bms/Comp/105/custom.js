    ...
    _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>" +
            "<tbody>" +
                "<tr style='height: 18px;'>" +
                    "<td>" +
                        "<p class='pseat-code'>{pseat._label}</p>" +
                        "<p class='ppayment {pseat._dathanhtoan}'><b>{pseat._pmInfo}</b></p>" +
                    "</td>" +
                "</tr>" +
                "<tr>" +
                    "<td>" +
                        "<p style='width:100%;height:16px;font-size:15px;'>" +
                            "<span class='cus-name'>{pseat._cname} <b class='ntk-pertrip'>{pseat._nTicketPerTrip}</b></span>" +
                            "<span class='cus-phone'>{pseat._cphone}</span></p>" +
                        "<p class='pnote'>" +
                            "<span> {pseat._fare}</span>" +
                            "<span class='pnote'> {pseat._note}</span></p>" +
                    "</td>" +
                "</tr>" +
            "</tbody>" +
            "</table></li>",
    ...
    _sTpl: "<li class='seat {seat._notallow} {seat._half}' data-position='{seat._coach}_{seat._row}_{seat._col}'>" +
                "<div class='{seat._class}'>" +
                    ...
                    "<div class='agentinfo clearfix'>" +
                        "<p>{seat._stageName}&nbsp;<span style='font-size:15px !important;'><b>{seat._fare}</b></span></p>" +
            ...
            "</li>",
    //_pNoSeat: true,
    _pStyleUrl: "/Comp/105/print.css?v=1.0.8",
    //_tplNumCol: 4,
