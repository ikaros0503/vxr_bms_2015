//Extend dict
define({
    _pStyleUrl: "/Comp/10586/print.css?v=1.0.1",
    // _specialPos: {
        // 50: {
    ...
    _pSpecialPos: {
        ...
        45: {
            "2_1_1": [1, 1, 2], "1_1_3": [1, 1, 4], "2_1_3": [1, 1, 5], "1_1_5": [1, 1, 7], "2_1_5": [1, 1, 8],
                ...
                "<div class='{seat._class}'>" +
                    ...
                    "<div class='agentinfo clearfix'>" +
                       // "<p>{seat._stageName}&nbsp;{seat._fare}</p>" +
                        ...
                        "<p class='cinfo' style='height:35px !important;'><b><span class='name' style='font-size: 13px !important'>{seat._cname}</span></b><span class='numT'>{seat._nTicketPerTrip}</span><span class='phone' style='font-size: 15px !important;'>&nbsp;&nbsp;{seat._cphone}</span></p>" +
   ...
   _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
          + "<tbody>"
          + "<tr style='height: 16px'><td><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p><p class='pcname'><b>{pseat._cname}&nbsp;{pseat._nTicketPerTrip}</b></p></td></tr>"
