define({
    ...
    checkHasTicket: {
        ...
        _c: {
            ...
            Status: "(($x) IN(2, 4, 5, 8) or (Status = 1 AND (ExpiredTime is null or ExpiredTime >= '" + new Date().toFormatString("iso") + "')))",
            TripDate: {
                params: '$Date,$Time',
                get: 'getTripDate'
            },
    ...
    items: [
        ...
        },
        {
            ...
            xtype: 'inputHidden01', label: "", form: true, cls: 'total-booked-seats', rights: '', options: [], noSave: true,
        },
        {
            name: 'TotalPaidSeats', cbb: false, grid: false, gQuery: true, gIdx: 3, fIdx: 13, ref: '.total-paid-seats', data: true,
            xtype: 'inputHidden01', label: "", form: true, cls: 'total-paid-seats', rights: '', options: [], noSave: true
        },
        //{
        ...
        },
        {
            ...
            gDis: "gDisSeatStatus", noSave: true
        },
        {
        ...
        },
        {
            ...
            label: "BaseId", form: false, cls: 'baseid', vType: 'num', noSave: true
        },
        {
        ...
        {
            name: 'CompId', grid: true, gQuery: true, gHide: true, gIdx: 100, data: true, noSave: true
        },
        {
            name: 'Type', grid: true, gQuery: true, gHide: true, gIdx: 100, data: true, noSave: true
        },
        {
            name: 'FromArea', grid: true, gQuery: true, copyFromBase: true, gHide: true, gIdx: 100, data: true, noSave: true
        },
        {
            name: 'ToArea', grid: true, gQuery: true, noSave: true, copyFromBase: true, gHide: true, gIdx: 100, data: true
        }
    ],
