...
define({
    start: function (o) {
        ...
        vbv('doBookMoreTicket', function (e) { // do book more ticket
            me._getCopyInfo(e.d.f, e.d.oldCode, e.d.fromArea, e.d.toArea, e.d.tdid, e.d.tId);
        });
    ...
    _getCopyInfo: function (f, oldCode, fromArea, toArea, tdId, tId) {
        var me = this;
        app.copyInfo = {};
        ...
        app.copyInfo["CurrentTripId"] = tId;
