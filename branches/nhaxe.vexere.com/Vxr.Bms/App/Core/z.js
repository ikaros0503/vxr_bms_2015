...
$.rights = { // List all Rights :    {val: giá trị trong Info (vd: 1|112|1); dtr: giá trị attr data-right trong tag (vd: S1230)
    ...
    mArea: { val: '', dtr: '' },                  //Quản lý địa điểm
    mArea_showAllArea: { val: '2|1201|1', dtr: '' },      //Show tất cả các điểm dừng
    mComp: { val: '', dtr: '' },                  //Quản lý công ty
    ...
    bQPay: { val: '1|5024|1', dtr: '' },                          //Thanh toán nhanh (Q)
...
app.oRights = {};
app.oRights["StageEnable"] = app.rights.indexOf($.rights.bEnStgTic.val) > 1 ? true : false;
...
var vv = {
    ...
    _getWinBody: function (o, xx) {
        var me = this;
        var rows = '', cells = ''; xx.sort(function (a, b) { var a1 = a.fIdx ? a.fIdx : 100, b1 = b.fIdx ? b.fIdx : 100; if (a1 == b1) return 0; return a1 > b1 ? 1 : -1; });
        var l = xx.length, c = 0;
        for (var i = 0; i < xx.length; i++) {
            ...
            if (!x.flex) x.flex = 1; if (x.form) c += x.flex; if (x.data) $.dx.push(x); if (x.grid && o.table && !o.table.hidden) me._applyGridConfigs(o, x);
    ...
    _applyChose: function (o, x) {
        ...
        $(x.ref).chosen(x.chosen).on('change', function (e, a) { x.e = e; x.a = a; o.vm.onChosenChange(x); });
    },

    //#region load

    initView: function (o) {
        o.view = $('.dialog-config'); o.view.unbind();
    },
    ...
    initGrid: function (o) {
        ...
        o.table = me._table; if (o.gFields) o.table.fields = o.gFields; else o.table.fields = {};
        if (o.pageSize) {
            o.table.pageSize = o.pageSize;
        }
    ...
    initForm: function (o) {
        ...
        o.view.html($.html('winTpl', c, true));
    },
...
$.xVehicle = function (x) {
    ...
    return {
        ...
        name: x.name, rootField: 'VehicleInfo',
        fIdx: x.fIdx, mType: x.type, //enum type
        gHide: false, grid: x.grid, gIdx: x.gIdx, ref: 'select.' + x.name,
        chosen: { on: true, width: "100%" },
