define({
    ...
    items: [
        { x: 'Id' },
        {
            ...
            formToGridOnly: true, defaultTrip: true, alwaysEnable: true, options: [], allowEmpty: true, nullLabel: 'Chọn chuyến',
        ...
        //Update xe
        {
            x: 'Vehicle', svc: 'svcVhc', rvc: 'rvcVhc',
        ...
        },
        {
            ...
            form: true, fIdx: 8, grid: true, gIdx: 7, gDis: 'gDisAid'
        },
        {
            x: 'Persons', svc: 'svcMem', rvc: 'rvcMem',
