...
var _dict = {
    ...
    _pssTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
        ...
        + "</tbody>"
        + "</table></li>",
    _pTitleTpl: "<table class='print-title'><tbody><tr><td><strong class='title'>{p._title}</strong></td><td colspan='2'><strong class='rname'>{p._rname}</strong></td></tr><tr><td>Chuyến:&nbsp;<strong class='time'>{p._time}</strong></td><td>Số xe:&nbsp{p._busNum}</td><td>Tài xế:&nbsp;{p._driverName}</td></tr></tbody></table>",
    _pNoSeat: false,
