define({
    loadAgentUI: function () {
        ...
        $('#agtComps').prepend('<input type="text" name="name" id="compKeyword" class="form-control input-sm" placeholder="Tìm nhà xe">');
...
$(document).ready(function () {
    ...
    $.applyRoute = function () {
        if ($.agtCfg.isApplyRoute) {
            $('.routeListFilterPanel').removeClass('hidden');
    ...
    $("body").on("tripChanged", function (e, d) {
        ...
        //  $(ref).jtable('deselectRows');
        /*var row = $($.agtCfg.compRef).jtable('getRowByKey', app.cid);
        if (row) {
           
        }*/
    });
    $("body").on("tripChangedWithoutReload", function (e, d) {
    ...
    $("body").on("tripNotFound", function (e) {
    ...
    $("body").on("applyBooking", function (e, d) {
        /* console.log('applyBooking', d);
         $.agtCfg.tripAjax['Time'] = '';
         $.loadPanel($.agtCfg.tripRef, $.agtCfg.tripAjax, $.agtCfg.tripFields, $.agtCfg.tripTrigger);*/
    });

    //changeCTripDate
    $("body").on("changeCTripTime", function (e, d) {
        //console.log('changeCTripTime', d);

        /* if ($.agtCfg.isApplyRoute) {
            $.agtCfg.tripAjax._c['Time'] = d;
            $.applyRoute();
    ...
    $("body").on("changeCTripDate", function (e, d) {
        //console.log('changeCTripTime', d);
