            ...
            <form id="LoginForm" class="col-sm-6 col-md-4 col-md-offset-4" runat="server">
                ...
                <script>
                    ...
                    function showCaptchaError(type) {
                        ...
                        switch (type) {
                            case 1: document.getElementById("ErrorMessage").innerText = "Captcha không được để trống.";
                                break;
                            case 2: document.getElementById("ErrorMessage").innerText = "Captcha không hợp lệ hoặc không đúng.";
                                break;
