...
(function ($) {
    $.extend(_dict, _dict,
    {
        _pStyleUrl: "/Comp/824/print.css?v=1.0.20",
        _specialPos: {
            45: {
                "1_7_5": [2, 7, 1]
            }
        ...
        _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
			  + "<tbody>"
			  + "<tr style='height: 16px'><td><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p></td></tr>"
			  + "<tr class=''><td><p class='pcname'>{pseat._cname}</p><p class='pcphone'> {pseat._cphone}</p></td></tr>"
