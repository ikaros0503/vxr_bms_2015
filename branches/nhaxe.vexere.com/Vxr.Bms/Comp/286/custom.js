...
(function ($) {
    $.extend(_dict, _dict,
    {
        _pTplNumCoach: 1,
        _pNoSeat: true,
        _pStyleUrl: "/Content/extend/286/print.css?v=1.0.0",
        ...
        _eTicket: {
            "sm": "<div style='width:330px; margin: 0 auto; padding-left: 20px;'><div class='col-xs-12 logonx' style='padding: 0;font-weight: 700;font-size: 20px;'><p style='width:100%;float:right;text-align:center;font-size:30px;margin:0;'>DU LỊCH CẢNH YẾN</p></div>"
                + "<div class='row' style='margin-top:10px;margin-bottom:5px;'><div class='col-xs-12'>"
                    + "<div style='float:left;width:100%;'>"
                        ...
                        + "<div style='float:right;width:65%;'>03 Hoàng Minh Giám, P.9, Q.Phú Nhuận, Tp.HCM</br>08.2244 68 66</div>"
                    + "</div>"
                    + "<div style='float:left;width:100%;'>"
                        + "<div style='float:left;width:35%;font-weight:bold;'>VP Đơn Dương</div>"
                        + "<div style='float:right;width:65%;'>huyện Đơn Dương, tỉnh Lâm Đồng</br>0633.847 155</div>"
                    + "</div>"
