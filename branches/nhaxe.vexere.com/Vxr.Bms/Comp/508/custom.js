...
(function ($) {
    $.extend(_dict, _dict,
    {
        ...
        _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
			  + "<tbody>"
			  + "<tr style='height: 18px'><td><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p><p class='pmInfo ppayment {pseat._onlyPaidBackGround}'>{pseat._stageName} {pseat._nTicketPerTrip}</p></td></tr>"
        ...
        _pStyleUrl: "/Comp/508/print.css?v=1.0.55",
