    ...
    $.extend(_dict, _dict,
    {
        _pSpecialPos: {
            ...
            53: {
                ...
                "1_6_1": [2, 4, 1], "1_6_3": [2, 3, 3], "1_6_5": [2, 3, 5],
                "2_6_1": [2, 3, 1], "2_6_3": [2, 4, 3], "2_6_5": [2, 4, 5],
        ...
        _pStyleUrl: "/Comp/836/print.css?v=1.0.9",
        _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
           + "<tbody>"
           + "<tr><td height='16px;'><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p><p class='ppickup {pseat._exported}'>{pseat._note}</p></td></tr>"
           ...
           + "</tbody>"
           + "</table></li>",
        _pm: [[1, { vi: "Tại văn phòng" }, 1, ""], [4, { vi: "Tài xế thu" }, 1, "TX"], [6, { vi: "Đại lý" }, 1, "DL"], [7, { vi: "VeXeRe" }, 1, "VXR"], [9, { vi: "Không thu tiền" }, 1, "VIP"]],
        _uForm: [
        "UpdateForm",
        [
