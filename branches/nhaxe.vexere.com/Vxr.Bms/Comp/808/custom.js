...
(function ($) {
    $.extend(_dict, _dict,
    {
        ...
        _pStyleUrl: "/Comp/808/print.css?v=1.0.9",
		_psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
			...
			+ "<tr><td><p><span class='pcname'>{pseat._cname}</span><span class='pcphone {pseat._exported}'>{pseat._cphone}&nbsp;<b class='ntk-pertrip'>{pseat._nTicketPerTrip}</b></span></p></td></tr>"
