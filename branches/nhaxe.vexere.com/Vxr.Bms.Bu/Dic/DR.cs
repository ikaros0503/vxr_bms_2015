...
namespace Vxr.Bms.Bu.Dic
{
    public class DR
    {
        ...
        {"rpStaffBySoldDate"  , new[]{"E", "1" , "Report2", "rp", "DOANH THU NHÂN VIÊN THEO NGÀY BÁN VÉ"}},
        {"rpStaffByPickupDate"  , new[]{"E", "1" , "Report2", "rp", "DOANH THU NHÂN VIÊN THEO NGÀY KHỞI HÀNH"}},
        {"rpBranchBySoldDate"  , new[]{"E", "1" , "Report2", "rp", "DOANH THU CHI NHÁNH/ĐẠI LÝ THEO NGÀY BÁN VÉ"}},
        {"rpBranchByPickupDate"  , new[]{"E", "1" , "Report2", "rp", "DOANH THU CHI NHÁNH/ĐẠI LÝ THEO NGÀY ĐI"}},
        {"rpRevenueByTrip"  , new[]{"E", "1" , "Report2", "rp", "DOANH THU THEO CHUYẾN XE"}},
        {"rpRevenueByRoute"  , new[]{"E", "1" , "Report2", "rp", "DOANH THU THEO TUYẾN"}},
        {"rpBranchByRoute"  , new[]{"E", "1" , "Report2", "rp8", "DOANH THU CHI NHÁNH THEO TUYẾN "}},
