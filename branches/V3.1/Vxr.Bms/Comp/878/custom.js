...
define({
    ...
    _eTicket: {
        ...
        "custom": {
            17001: {
                "sm": "<div style='width:459px; margin: 0 auto; padding-left: 0px;'><div class='col-xs-12 logonx' style='padding: 0 0 10px;font-weight: 700;font-size: 16px;'><img src='http://nhaxe.vexere.com/Images/eticket/hunglong-ve.png' style='width: 70px;float:left;margin-left: 33px;' /><p style='width:76%;float:right;text-align:center;font-size:29px;padding:2px 0 0 0;'>HƯNG LONG</p></div>"
                    ...
                    + "<div class='row' style='margin-top:10px;margin-bottom:5px;'><div class='col-xs-12'>"
                        ...
                        + "<div style='float:left;width:100%;'>"
                            ...
                            + "<div style='float:right;width:60%;margin-left: 10px;'>338 Trần Khát Chân, Q.Hai Bà Trưng</br>04.221 21 855 - 04.3972 45 05</div>"
                        + "</div>"
                        + "<div style='float:left;width:100%;'>"
                    ...
                    + "<p style='float: left;width: 100%;text-align: left;'><icon style='font-size:23px;line-height:15px;height:17px;vertical-align: bottom; display:inline-block;'>&#8226;</icon>&nbsp;<i>Vé có giá trị trong ngày.</i></p><p style='float: left;width: 100%;text-align: left;'><icon style='font-size:23px;line-height:15px;height:17px;vertical-align: bottom; display:inline-block;'>&#8226;</icon>&nbsp;<i>Nếu đổi vé hoặc chuyển ngày thì không mất phí.<i></p></div></div></div>",

                "lg": "<div style='width:459px; margin: 0 auto; padding-left: 0px;'><div class='col-xs-12 logonx' style='padding: 0 0 10px;font-weight: 700;font-size: 16px;'><img src='http://nhaxe.vexere.com/Images/eticket/hunglong-ve.png' style='width: 70px;float:left;margin-left: 33px;' /><p style='width:76%;float:right;text-align:center;font-size:29px;padding:2px 0 0 0;'>HƯNG LONG</p></div>"
                    // + "<div class='row' style='border:1px solid #000;text-align:center;clear:both;padding:5px 10px;width:55%;margin:0 auto;height:30px;line-height:20px;font-weight:bold;font-size:17px;'>GIƯỜNG NẰM CAO CẤP</div>"
                    + "<div class='row' style='margin-top:10px;margin-bottom:5px;'><div class='col-xs-12'>"
