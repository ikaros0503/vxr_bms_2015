...
function checkVersion() {
    var cValue = getCookie('VxrVsn');
    if (cValue == "") {
        setCookie('VxrVsn', app.vsn, 5);
    } else {
        if (cValue != app.vsn) {
...
function loadLinks() {
    ...
    $('<link>').appendTo('head').attr({ type: 'text/css', rel: 'stylesheet', media: 'screen and (max-width: 480px)' }).attr('href', "Styles/responsive/max-width-480.min.css?v=" + app.vsn);
    $('<link>').appendTo('head').attr({ type: 'text/css', rel: 'stylesheet', media: 'screen and (max-width: 768px)' }).attr('href', "Styles/responsive/max-width-768.min.css?v=" + app.vsn);
    $('<link>').appendTo('head').attr({ type: 'text/css', rel: 'stylesheet', media: 'screen and (max-width: 960px)' }).attr('href', "Styles/responsive/max-width-960.min.css?v=" + app.vsn);
    $('<link>').appendTo('head').attr({ type: 'text/css', rel: 'stylesheet', media: 'screen and (max-width: 1024px)' }).attr('href', "Styles/responsive/max-width-1024.min.css?v=" + app.vsn);
...
function startBms() {
    $.ajax({
        ...
        app.toRouteId = 0;
        app.oRights = {};
        app.oRights["StageEnable"] = app.rights.indexOf('2|5002|1') > 1 ? true : false;
