                    ...
                    if (typeof item != "undefined" && item != null) {
                        ...
                        if (nbooked > 0) {
                            $result.append(
                                ...
                                .attr('phone', cphone)
                                .html(cname + " <span class='vred'>(" + cphone + ")</span><span style=\"color: gray;font-size: smaller;font-weight: lighter;\">&nbsp;" + (item[2] == null ? '' : ('(' + item[2] + ')')) + "&nbsp;</span>" + "- Đã đặt <span class='vred'>" + nbooked + "</span> vé " + lbooked.filter(function (val) { return vIsEstStr(val); }).join(', ') + " / <span class='vred'>" + tbooked.toMn() + "₫</span> / " + tname + " / ngày <span class='vred'>" + tdate.toFormatString('dd-mm-yyyy') + "</span> lúc <span class='vred'>" + tdate.toFormatString('hh:mm') + "</span> " + cpickup + cnote + '<button class="customer-profile customer-profile-item btn btn-sm btn-primary" title="Chỉnh sửa thông tin khách hàng" data-phone="' + cphone + '"><i class="glyphicon glyphicon-edit"></i> Edit</button>')
                        ...
                        if (ncancelled > 0) {
                            $result.append(
                                ...
                                .attr('ttime', tdate.toFormatString('hh:mm'))
                                .attr('phone', cphone)
                                .html(cname + " <span class='vred'>(" + cphone + ")</span><span style=\"color: gray;font-size: smaller;font-weight: lighter;\">&nbsp;" + (item[2] == null ? '' : ('(' + item[2] + ')')) + "&nbsp;</span>" + "- Đã hủy <span class='vred'>" + ncancelled + "</span> vé " + lcancelled.filter(function (val) { return vIsEstStr(val); }).join(', ') + " / <span class='vred'>" + tcancelled.toMn() + "₫</span> / " + tname + " / ngày <span class='vred'>" + tdate.toFormatString('dd-mm-yyyy') + "</span> lúc <span class='vred'>" + tdate.toFormatString('hh:mm') + "</span> " + cpickup + cnote + '<button class="customer-profile customer-profile-item btn btn-sm btn-primary" title="Chỉnh sửa thông tin khách hàng" data-phone="' + cphone + '"><i class="glyphicon glyphicon-edit"></i> Edit</button>')
                                //.html(cname + " <span class='vred'>(" + cphone + ")</span><span style=\"color: gray;font-size: smaller;font-weight: lighter;\">&nbsp;" + (item[2] == null ? '' : ('(' + item[2] + ')')) + "&nbsp;</span>" + "- Đặt:&nbsp;<span class='vred'>" + cbooked + "</span> - Hủy:&nbsp;<span class='vred'>" + ccancelled + "</span> / Đã hủy - <span class='vred'>" + ncancelled + "</span> vé " + lcancelled.filter(function (val) { return vIsEstStr(val); }).join(', ') + " / <span class='vred'>" + tcancelled.toMn() + "₫</span> / " + tname + " / ngày <span class='vred'>" + tdate.toFormatString('dd-mm-yyyy') + "</span> lúc <span class='vred'>" + tdate.toFormatString('hh:mm') + "</span> " + cpickup + cnote + '<button class="customer-profile customer-profile-item btn btn-sm btn-primary" title="Chỉnh sửa thông tin khách hàng" data-phone="' + cphone + '"><i class="glyphicon glyphicon-edit"></i> Edit</button>')
                            );
                            totalResult++;
                        }
                        //update by Thanh
