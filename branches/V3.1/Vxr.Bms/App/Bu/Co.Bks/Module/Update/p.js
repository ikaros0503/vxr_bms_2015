...
define({
            ...
            if (e.d) {
                try {
                    ...
                    if (fObj) {
                        ...
                        me._bindEventOnUpdateForm($form, st, tId, tName, tDate, tBus, sc, stopPoints, offsetMinute, cTrip, tdid, lmDate, cs, lpp, ltp, tTime, tInfo);
                        $form.modal('show');
    ...
    _bindEventOnUpdateForm: function (f, st, tId, tName, tDate, tBus, sc, stopPoints, offsetMinute, cTrip, tdid, lmDate, cs, lpp, ltp, tTime, tInfo) {
        /// <summary>
