define({
    ...
    gTripByDate: function (d, f, rl, opt, cb) {
        ...
        if (rl) {
            var df = 'Id, Name, Info, SeatTemplateInfo, FareInfo, StatusInfo, BaseId, Type, Time, Alias, TeamInfo, VehicleInfo, FromArea, ToArea, Note, RouteInfo, SeatSummaryInfo, TotalSeats, ClosedStatus, PassengerMoney, ProductMoney, FeeMoney, BranchReceiveProduct, RealDepartureTime, PickedPointsInfo, TransferPointsInfo, NewFare, DisplayOrder, Description';
            var obj = {
                _a: 'fGetTrip',
                _c: {
                    CompId: app.cid,
