...
namespace Vxr.Bms.Core
{
    public class L
    {
        ...
        {
            GlobalContext.Properties["LogName"] = "log.txt";
        ...
        {
            GlobalContext.Properties["LogName"] = "sql.txt";
            XmlConfigurator.Configure(); //only once
            Log.InfoFormat("\n" + sql);
        }

        public void LogReport(string sql)
        {
            GlobalContext.Properties["LogName"] = "report.txt";
            XmlConfigurator.Configure(); //only once
            Log.InfoFormat("\n" + sql);
        }
    }
