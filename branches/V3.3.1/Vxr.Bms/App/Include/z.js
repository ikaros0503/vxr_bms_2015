...
$.start = function (c, data) {
    var type = c[10], o, p, t; //T = type
    $.hideAndShowTpl(c);
    require($.getJsFiles(c), function (x1, x2, x3) {
        switch (type) {
            case 0: o = x1; p = x2, t = x3; break;
            case 1: break;
            case 2: p = x1; break;//Load p file only
            case 3: o = x1; break;//Load o file only
            default: break;
        }
        if (!o) o = {}; if (!p) p = {}; if(!t) t= {}
        o.p = p; o.c = c; o.appId = c[7];
        o.t = t;//TODO: Need clone?
        o.data = data;
        $.ajaxSetup({ cache: true });
