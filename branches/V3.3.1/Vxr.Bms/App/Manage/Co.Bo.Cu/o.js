define({
    ...
    items: [
        { x: 'Id' },
        {
            ...
            form: true, fIdx: 1, cls: 'name', rights: '', grid: true, gIdx: 1, gQuery: true, xSearch: true,
        },
        {
            ...
            grid: true, gIdx: 2, gQuery: true, xSearch: true,
        },
        {
        ...
        },
        {
            ...
            grid: true, gIdx: 4, gQuery: true, xSearch: true,
            gDis: 'gDisGender',
        },
        {
