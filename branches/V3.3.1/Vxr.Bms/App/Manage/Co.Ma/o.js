define({
    ...
    grid: false, xWidth: '', cols: 4, winCls: 'intComp', useSmCls: true, autoClear: true,
    ...
    items: [
        ...
        },
        {
         ...
         },
         {
          ...
          {
              xtype: 'iconbutton', name: 'btnSearchCom', label: 'Tìm kiếm', ref: 'button.searchCom', gQuery: false,
              form: true, cls: 'btn-info searchCom', iconCls: 'glyphicon-search', fIdx: 6, flex: 1, data: true,
              listeners: [{ xClick: 'onSearchComp' }]
          },
          {xtype: 'nothing', cls: 'srcCpnRst', form: true, fIdx: 7, flex: 4},
         {
             xtype: 'hr', cls: 'mt10 mb10', fIdx: 8, flex: 4, 
             form: true, grid: false, gIdx: 1, gQuery: false, notInRow: true,
         },
         {
             xtype: 'fromTitle099', title: 'Tạo chi nhánh- đại lý', fIdx: 9, flex: 4, sty: "margin-left: 15px ! important;",
             form: true, grid: false, gQuery: false, notInRow: true,
         },
        {
            xtype: 'textbox', name: 'Name', label: "Tên C.Nhánh - Đ.Lý", ref: 'input.CN-name', data: true,
            form: true, fIdx: 10, cls: 'CN-name', required: true, requiredCls: 'bdred', rights: '',
            grid: true, gIdx: 1, gQuery: false
        },
         {
             xtype: 'textbox', name: 'Code', label: "Mã code", ref: 'input.CN-code-info', data: true,
             form: true, fIdx: 11, cls: 'CN-code-info', rights: '',
             grid: true, gIdx: 1, gQuery: false
         },
         {
             xtype: 'textbox', name: 'PhoneInfo', label: "Điện thoại", ref: 'input.CN-phone-info', data: true,
             form: true, fIdx: 12, cls: 'CN-phone-info', rights: '', vtype: 'phone',
             grid: true, gIdx: 1, gQuery: false
         },
         {
             xtype: 'textbox', name: 'AddressInfo', label: "Địa chỉ", ref: 'CN-input.address-info', data: true,
             form: true, fIdx: 13, cls: 'CN-address-info', rights: '',
             grid: true, gIdx: 1, gQuery: false
         },
         {
             xtype: 'iconbutton', name: 'btnsaveCN', label: 'Thêm', ref: 'button.saveCN', gQuery: false, disabled: 'disabled="disabled"',
             form: true, cls: 'btn-success saveCN save', iconCls: 'glyphicon-plus', fIdx: 14, flex: 1, data: true, sty: 'margin-left: 15px;',
         ...
         },
         {
             ...
             form: true, cls: 'btn-primary refreshCN', iconCls: 'glyphicon-refresh', fIdx: 15, flex: 1, data: true,
             listeners: [{ xClick: 'onCNClear' }]
         },
         {
             xtype: 'iconbutton', name: 'btnSearchAgent', label: 'Tìm kiếm', disabled: 'disabled', ref: 'button.searchAgt', gQuery: false,
             form: true, cls: 'btn-info searchAgt', iconCls: 'glyphicon-search', fIdx: 15, flex: 1, data: true,
             listeners: [{ xClick: 'onSearchAgt' }]
         },
         { xtype: 'nothing', cls: 'srcAgtRst', form: true, fIdx: 16, flex: 4 },
         {
             xtype: 'hr', cls: 'mt10 mb10', fIdx: 16, flex: 4, 
             form: true, grid: false, gIdx: 1, gQuery: false, notInRow: true,
         },
         {
             xtype: 'fromTitle099', title: 'Tạo nhân viên', fIdx: 17, flex: 4, sty: "margin-left: 15px ! important;",
             form: true, grid: false, gQuery: false, notInRow: true,
         },
         {
             xtype: 'textbox', name: 'FullName', label: "Họ và tên", ref: 'input.nv-full-name', data: true,
             form: true, fIdx: 18, cls: 'nv-full-name', required: true, requiredCls: 'bdred', rights: '',
             grid: true, gIdx: 1, gQuery: false
         },
         {
             xtype: 'textbox', name: 'PhoneInfo', label: "Điện thoại", ref: 'input.nv-phone-info', data: true,
             form: true, fIdx: 19, cls: 'nv-phone-info', rights: '', vtype: 'phone',
             grid: true, gIdx: 1, gQuery: false
         },
         {
             xtype: 'textbox', name: 'EmailInfo', label: "Email", ref: 'input.nv-email-info', data: true,
             form: true, fIdx: 20, cls: 'nv-email-info', rights: '',
             grid: true, gIdx: 1, gQuery: false
         },
         {
             xtype: 'combobox', name: 'AgentId', cbb: true, ref: '.agent-id', data: true, fIdx: 21,
         ...
         },
          {
              ...
              form: true, cls: 'btn-success saveNhanVien save', iconCls: 'glyphicon-plus', fIdx: 22, flex: 2, data: true, sty: 'margin-left: 15px;',
          ...
          },
         {
             ...
             form: true, cls: 'btn-primary refreshNV', iconCls: 'glyphicon-refresh', fIdx: 23, flex: 2, data: true,
             listeners: [{ xClick: 'onNVClear' }]
         },
         {
             xtype: 'hr', cls: 'mt10 mb10', fIdx: 24, flex: 4, 
             form: true, grid: false, gQuery: false, notInRow: true,
         },
         {
             xtype: 'fromTitle099', title: 'Tạo tài khoản', fIdx: 25, flex: 4, sty: "margin-left: 15px ! important;",
             form: true, grid: false, gQuery: false, notInRow: true,
         },
         {
             ...
             grid: true, gIdx: 1, gQuery: false, fIdx: 26
         },
        {
            ...
            grid: false, gIdx: 1, gQuery: false, fIdx: 27
        },
        {
            xtype: 'combobox', name: 'AgentId1', cbb: true, ref: '.tk-agent-id', data: true, fIdx: 28,
        ...
        },
        {
            ...
            grid: false, gQuery: false, gIdx: 1, fIdx: 29
        },

        {
            xtype: 'iconbutton', name: 'btnsavetk', label: 'Thêm', ref: 'button.saveTK', gQuery: false, disabled: 'disabled="disabled"',
            form: true, cls: 'btn-success saveTK save', iconCls: 'glyphicon-plus', fIdx: 30, flex: 2, data: true, sty: 'margin-left: 15px;',
        ...
        },
         {
             ...
             form: true, cls: 'btn-primary refreshTK', iconCls: 'glyphicon-refresh', fIdx: 31, flex: 2, data: true,
             listeners: [{ xClick: 'onTKClear' }]
         },

        {
            xtype: 'input_hidden_khoitao', cls: 'congty_id_hidden', data: true, label: 'Hidden',
            form: true, grid: false, gQuery: false, fIdx: 32, flex: 4,
        },
        {
            xtype: 'input_hidden_khoitao', cls: 'ChiNhanh_id_hidden', data: true, label: 'Hidden',
            form: true, grid: false, gQuery: false, fIdx: 33, flex: 4,
        },
