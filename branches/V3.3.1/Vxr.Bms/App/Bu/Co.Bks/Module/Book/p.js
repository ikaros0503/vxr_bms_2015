define({
    ...
    _bookTicket: function (seat, tData) {
        ...
        try {
            ...
            var completeReload = function (u, r, l, t) {
                ...
                //Reload sheet
                vbf('reloadBookingSheet', {}, function () { vbf('doGetTotalSeats'); });
    ...
    _estStStk: function (seat) {
        ...
        try {
            ...
            console.log('(E) Module.Book.p._estStStk', e);
            return false;
        }
    },
    _createBookTicketObj: function (seat, tData) {
        try {
            ...
            console.log('(E) Module.Book.p._createBookTicketObj', e);
            return { _a: 'BookTicket', _c: [], _d: [] };
        }
    },
    _getDptrTime: function (tData) {
        try {
            ...
            console.log('(E) Module.Book.p._getDptrTime', e);
            return {};
        }
    },
