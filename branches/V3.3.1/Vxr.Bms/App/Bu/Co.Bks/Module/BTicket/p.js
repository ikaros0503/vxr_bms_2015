    ...
    init: function () {
        ...
        var initFilter = function () {
            ...
            var data = {
                ...
                createdDateEnd: formatDatepicker($(jHtml.filterToDate), "YYYY-MM-DD 23:59:59"),
    ...
    getItemFromRecord1: function (record, index) {
        ...
        if (typeof record != 'undefined' && record != null) {
            ...
            var result = {
                ...
                "statusDateDisplay": (statusDate != null &&statusDate!="") ? 'display' : 'none',
