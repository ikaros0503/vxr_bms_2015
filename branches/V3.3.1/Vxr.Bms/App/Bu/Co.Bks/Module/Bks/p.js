...
define({
    start: function (o) {
        ...
        vbe('onPrintETicket', 'doPrintETicket'); // print ETicket
        vbe('onPrintETicketSave', 'collectDataForPrintETicket'); // collect data for print eticket
        ...
        //vbe('onMoveSeats', 'doMoveSeats'); // Move seats
        

        vbv('resetSeatStack', function (e) {
            app.seatStack = [];
            if (e.cb) e.cb.call();
        }); // reset seat stack
    }
