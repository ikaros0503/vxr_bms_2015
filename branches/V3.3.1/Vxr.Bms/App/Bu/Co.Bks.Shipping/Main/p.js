define({
    ...
    loadProduct: function (o) {
        ...
        $.getScript("Comp/" + app.cid + "/product-custom.js?v=" + app.vsn, function () {
            me._reloadProduct();
        });
    },
    ...
    $.widget("custom.product", {
        ...
        *************************************************************************/
        _initListener: function () {
            var me = this;
            vev('div.product-toolbar select[name="TripId"]', 'change', function () {
                var htmlTimeSlot = '';
                $.each(me._$trip, function (index, value) {
                    if (value[0] == me._getTripIdFromView()) {
            ...
            vev('div.product-toolbar select[name="TimeSlot"]', 'change', function () {
                me._reloadProContainer();
            });
            ...
            vev('button.btn-nhap-kho', 'click', function () {
            ...
            vev('div.product-toolbar div.btn-filter a.kho-hang-di', 'click', function () {
            ...
            vev('div.product-toolbar div.btn-filter a.kho-hang-ve', 'click', function () {
                $('div.product-toolbar div.btn-filter a.btn-typeofview').removeClass('btn-danger').removeClass('btn-default').addClass('btn-default');
                $(this).removeClass('btn-default').addClass('btn-danger');
            ...
            vev('div.product-toolbar div.btn-filter a.xem-chuyen', 'click', function () {
                $('div.product-toolbar div.btn-filter a.btn-typeofview').removeClass('btn-danger').removeClass('btn-default').addClass('btn-default');
            ...
            vev('button.btn-save-pro', 'click', function () {
                $(this).button('loading');
                me._submitSavePro($(this).closest('div.nhap-hang'));
            });
            vev('button.nhap-hang-dong', 'click', function () {
                me._$formNhapHang.slideUp('fast');
                $('button.btn-nhap-kho').removeClass('open');
                me._clearForm();
            });
            vev('button.btn-in-phoi-hang', 'click', function () {
                me._initPhoiHang();
            });
            vev(me._$pageSizeElement, 'change', function () {
        ...
        _bindEventLenXe: function () {
            ...
            var listProId = [];
            var listSuccess = [];
            vev('div.product-matrix button.btn-len-xe', 'click', function () {
        ...
        _bindEventDaNhan: function () {
            ...
            var listProId = [];
            var listSuccess = [];
            vev('div.product-matrix button.btn-da-nhan', 'click', function () {
                $.each($('div.product-matrix table.product-list tbody input[name="ProId"]:checked'), function (index, ele) {
                    var proId = $(ele).closest('tr').attr('data-id');
                    listProId.push(proId);
                    var requestSuccess = function () {
        ...
        _bindEventDaGiao: function () {
            ...
            var listProId = [];
            var listSuccess = [];
            vev('div.product-matrix button.btn-da-giao', 'click', function () {
                $.each($('div.product-matrix table.product-list tbody input[name="ProId"]:checked'), function (index, ele) {
                    var proId = $(ele).closest('tr').attr('data-id');
                    listProId.push(proId);
                    var requestSuccess = function () {
        ...
        _autoFormatFare: function () {
            vev('input[name="FareOfPro"]', 'keyup', function () {
