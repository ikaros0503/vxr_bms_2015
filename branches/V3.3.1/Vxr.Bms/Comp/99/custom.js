...
define({
    _specialPos: {
        46: {
            "1_7_3": [1, 7, 2], "1_7_5": [1, 7, 3], "1_7_2": [1, 7, 4], "1_7_4": [1, 7, 5],
            "2_7_3": [2, 7, 2], "2_7_5": [2, 7, 3], "2_7_2": [2, 7, 4], "2_7_4": [2, 7, 5]
        }
    },
    ...
    _limitedMinuteBefore: 10080, // giới hạn thời gian là 1 ngày sẽ không được đặt vé trong quá khứ
    ...
    //_pTplNumCoach: 1,		
    _pStyleUrl: "/Comp/99/print.css?v=1.0.12",
    ...
    //+ "<tr><td><p style='width: 50%;'>{pseat._fare}</p></td></tr>"
    + "</tbody>"
    + "</table></li>",
    ...
    _eTicket: {
        ...
        "custom": {
            1939: {
                "sm": "<div style='width:330px; margin: 0 auto; padding-left: 20px;height: 80px;'><div class='col-xs-12 logonx' style='padding: 0;font-weight: 700;font-size: 16px;'><img src='http://nhaxe.vexere.com/Images/eticket/thanh-tran.jpg' style='width: 93px;float:left;' /><p style='width:70%;float:right;text-align: left;font-size:29px;padding:2px 0 0 0;height: 40px;line-height: 65px;'>Thanh Trân</p></div>"

                    + "<div class='row' style='margin-top:10px;margin-bottom:5px;'><div class='col-xs-12'>"
                        + "<div style='float:left;width:100%;'>"
                            + "<div style='float:left;width:35%;font-weight:bold;'>Vp EaKar</div>"
                            + "<div style='float:right;width:65%;'>192 Nguyễn Tất Thành, T.T EaKar</br>Tỉnh Đắk Lắk</br>0979.277.277 - 0974.855.855</div>"
                        + "</div>"
                        + "<div style='float:left;width:100%;'>"
                            + "<div style='float:left;width:35%;font-weight:bold;'>B.X Miền Đông</div>"
                            + "<div style='float:right;width:65%;'>Quầy vé 88, 292 Đinh Bộ Lĩnh</br>P.26, Q.Bình Thạnh, Tp HCM</br>0979.277.277 - 0974.855.855</div>"
                        + "</div>"
