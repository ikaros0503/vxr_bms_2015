...
define({
    ...
    _specialPos: {
        42: {
            "1_6_5": [1, 7, 2], "1_7_1": [1, 6, 5], "1_7_2": [1, 7, 1],
            "2_6_5": [2, 7, 2], "2_7_1": [2, 6, 5], "2_7_2": [2, 7, 1]
        },
    },
    ...
    _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
          ...
          + "<tr style='height: 18px'><td><p class='pcname'>{pseat._cname}</p><p class='pcphone'><b>{pseat._cphone}</b>&nbsp;<b class='ntk-pertrip'>{pseat._nTicketPerTrip}</b></p></td></tr>"
          + "<tr><td><p class='pnote' style='clear:both;'>{pseat._note}</p></td></tr>"
          + "</tbody>"
          + "</table></li>",
    _pStyleUrl: "/Comp/139/print.css?v=1.0.25",
