/****** Object: View [dbo].[zgcl_Ticket04] Script Date: 04/08/2015 11:00:05 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT        a.Id, a.Type, a.Code, a.Name, a.Note, a.Serial, a.TripDate, a.TripTime, a.TripAlias, a.FromArea, a.ToArea, a.SeatCode, a.PassCode, a.RoundTripCode, a.FromValid, a.ToValid, a.PickupDate, a.PickupInfo, 
                         ...
                         a.IsConfirmed, a.ResponsibilityUser, a.PickOrReturnDate, a.BookingCode, a.DiscountType, a.FinalPrice, a.Name AS PersonName, b.PersonId AS StaffId, a.NumOfSend, a.FirstUserUpdated, a.PrintStatus, a.NumOfPrint,
						 a.FromStop, a.ToStop
FROM            dbo.zgcl_Ticket03 AS a LEFT OUTER JOIN
                         dbo.Account AS b ON a.UserCharge = b.Username
