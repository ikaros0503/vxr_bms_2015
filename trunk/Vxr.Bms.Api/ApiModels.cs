...
namespace Vxr.Bms.Api
{
    public class APIModels
    {
        ...
        public static bool ApiIsVms = (Convert.ToInt32(ConfigurationManager.AppSettings["ApiIsVms"]) == 1);
        ...
        public object BookTicket(object obj)
        {
            try
            {
                var accessToken = _getAccessToken();
                if (accessToken == null) return new { Result = 0 };
                var url = ApiIsVms ? "/booking/vms" : "/booking/offline";
                var request = WebRequest.Create(_apiUrl + url);
                request.Method = "post";
                request.ContentType = "application/x-www-form-urlencoded";
                var postData = new StringBuilder();
                postData.Append("access_token=" + accessToken);
        ...
        public object UpdateTicket(object obj)
        {
            try
            {
                ...
                for (var i = 0; i < datas.Length; i++)
                {
                    if (datas[i].ContainsKey("Id"))
                    {
                        datas[i]["Id"] = conds[i]["Id"];
                    }
                    else
                    {
                    ...
                    foreach (var d in datas[i])
                    {
                        ...
                        {
                            ticket.Add(allField[d.Key], d.Value);
                        }
                    }
                ...
                foreach (var d in data)
                {
                    switch (d.Key)
                    {
                        ...
                        case "FeeMoney":
                            ...
                            break;
                        case "Description":
                            postData.Append("&description=" + d.Value);
                            break;
                    }
                }
        ...
        public object BusTicketStatus(object obj, string method)
        {
            try
            {
                ...
                var ip = (Dictionary<string, object>)obj;
                var data = ip["_da"] as Dictionary<string, object>;
                //var conds = ((IEnumerable)ip["_c"]).Cast<Dictionary<string, object>>().ToArray();
                foreach (var d in data)
                {
                    switch (d.Key)
                    {
                        case "XTripId":
                            postData.Append("&trip_id=" + d.Value);
                            break;
                        case "Info":
                            postData.Append("&info=" + d.Value);
                            break;
                        case "TimeLimit":
                            postData.Append("&time_limit=" + d.Value);
                            break;
                        case "XDate":
                            postData.Append("&date=" + d.Value);
                            break;
                        case "XStatus":
                            postData.Append("&status=" + d.Value);
                            break;
                        case "XTime":
                            postData.Append("&time=" + d.Value);
                            break;
                        case "StopPoints":
                            postData.Append("&stop_points=" + d.Value);
                            break;
                        case "XTypeId":
                            postData.Append("&type=" + d.Value);
                            break;
                ...
                if (tk.data != null && tk.data.message.ToString().Equals("success"))
                {
                    return new { Result = 1, Message = "Success" };
                }
                return new { Result = 0, Message = "Some error!" };
            }
            catch (WebException e)
        ...
        public object InsertCampaign(object obj)
        {
            try
            {
                var accessToken = _getAccessToken();
                if (accessToken == null) return new object();
                WebRequest request = WebRequest.Create(_apiUrl + "/campaign");
                request.Method = "post";
                request.ContentType = "application/x-www-form-urlencoded";
                var postData = new StringBuilder();
                postData.Append("access_token=" + accessToken);
                ...
                foreach (var d in data)
                {
                    switch (d.Key)
                    {
                        ...
                        case "StartDate":
                            ...
                            {
                                var dt = Convert.ToDateTime(d.Value.ToString());
                                postData.Append("&start_date=" + dt.ToString("dd-MM-yyyy"));
                            }
                            catch (Exception) { }
                            break;
                        case "ExpireDate":
                            ...
                            {
                                var dt = Convert.ToDateTime(d.Value.ToString());
                                postData.Append("&expire_date=" + dt.ToString("dd-MM-yyyy"));
                            }
                            catch (Exception) { }
                            break;
                        case "Status":
                        ...
                        case "Type":
                            ...
                            break;
                        case "Repeatable":
                            postData.Append("&coupon_repeat=" + d.Value);
                            break;
                        case "Unit":
                            postData.Append("&coupon_unit=" + d.Value);
                            break;
                        case "CampaignName":
                            postData.Append("&name=" + d.Value);
                            break;
                        case "Description":
                            ...
                            break;
                        case "CouponValue":
                            postData.Append("&coupon_value=" + d.Value);
                            break;
                        case "Total":
                            postData.Append("&coupon_total=" + d.Value);
                            break;
                        case "Scope":
                            postData.Append("&coupon_scope=" + d.Value);
                            break;
                        case "Info":
                            postData.Append("&info=" + d.Value);
                            break;
                ...
                if (tk.data != null && tk.data.message.ToString().Equals("success"))
                {
                    return new { Result = 1, Records = tk.data.campaign_id.ToString(), Message = "" };
                }
        ...
        public object UpdateCampaign(object obj)
        {
            try
            {
                var accessToken = _getAccessToken();
                ...
                foreach (var d in data)
                {
                    switch (d.Key)
                    {
                        ...
                        case "StartDate":
                            ...
                            {
                                postData.Append("&start_date=" + d.Value);
                            }
                            break;
                        case "ExpireDate":
                            try
                            ...
                            {
                                postData.Append("&expire_date=" + d.Value);
                            }
                            break;
                        case "Status":
                            postData.Append("&status=" + d.Value);
