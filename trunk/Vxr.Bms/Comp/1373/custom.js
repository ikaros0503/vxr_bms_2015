//Extend dict
define({
        _pStyleUrl: "/Comp/1373/print.css?v=1.0.1",
        _specialPos: {
			 43: {
                 "1_6_5": [1, 6, 3], "1_6_4": [1, 6, 2], "1_6_3": [1, 6, 1], "1_6_2": [1, 7, 1], "1_6_1": [1, 6, 5], "1_7_1": [1, 6, 4], "1_7_3": [1, 7, 2], "1_7_2": [1, 7, 3],
				 "2_6_5": [2, 6, 3], "2_6_4": [2, 6, 2], "2_6_3": [2, 6, 1], "2_6_2": [2, 6, 5], "2_6_1": [2, 6, 4]
             },
			 47: {
                  "1_6_5": [1, 6, 3], "1_6_4": [1, 6, 2], "1_6_3": [1, 6, 1], "1_6_2": [1, 7, 1], "1_6_1": [1, 6, 5], "1_7_1": [1, 6, 4], "1_7_3": [1, 7, 2], "1_7_2": [1, 7, 3],
				  "2_6_5": [2, 6, 3], "2_6_4": [2, 6, 2], "2_6_3": [2, 6, 1], "2_6_2": [2, 7, 2], "2_6_1": [2, 6, 5],
				  "2_7_5": [2, 6, 4], "2_7_4": [2, 7, 5], "2_7_3": [2, 7, 4], "2_7_2": [2, 7, 3]
              }
         },
        _pSpecialPos: {
					43: {
				...
				"1_7_1": [1, 8, 1], "1_7_2": [1, 8, 2], "1_7_3": [1, 8, 3], "1_7_4": [1, 8, 4]
				    },
					47: {
				"2_1_1": [1, 1, 1], "1_1_1": [1, 1, 2], "2_1_3": [1, 1, 4], "1_1_3": [1, 1, 5], "2_1_5": [1, 1, 7], "1_1_5": [1, 1, 8],
                "2_2_1": [1, 2, 1], "1_2_1": [1, 2, 2], "2_2_3": [1, 2, 4], "1_2_3": [1, 2, 5], "2_2_5": [1, 2, 7], "1_2_5": [1, 2, 8],
				...
				"1_6_1": [1, 6, 1], "1_6_2": [1, 6, 2], "1_6_3": [1, 6, 3], "1_6_4": [1, 6, 4], "1_6_5": [1, 6, 5],
				"2_6_1": [1, 7, 1], "2_6_2": [1, 7, 2], "2_6_3": [1, 7, 3], "2_6_4": [1, 7, 4], "2_6_5": [1, 7, 5],
				"2_7_5": [1, 8, 1], "2_7_4": [1, 8, 2], "2_7_3": [1, 8, 3], "2_7_2": [1, 8, 4],
				"1_7_1": [1, 9, 1], "1_7_2": [1, 9, 2], "1_7_3": [1, 9, 3]
				    }
	...
	_hasDriverTrip: true,
		...
		_hasMergeTransfer: { 22443: true, 22434: true, 22438: true, 22367: true, 22439: true, 22447: true },
		...
		_pTitleTpl: "<table>" +
						...
						"<tbody>" +
							 "<tr>" +
								"<p style='height:5px;'>" +
								"<span>&nbsp;&nbsp;<b>{p._time}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>" +
								"<span>Tuyến:&nbsp;<b>{p._rname}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>" +
								"<span>Số xe:&nbsp<b>{p._busNum}</b></span>" +
									//<b>{p._busNum}</b>								
								"</p>" +
							 "</tr>" +
							"<tr>" +
								"<p style='height:5px;'>" +
								"<span>&nbsp;&nbsp;<b>{p._driverName}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>" +	
								"<span><b>LX 1:</b>&nbsp;...................................</span>" +
								"<span><b>LX 2:</b>&nbsp;...................................</span>" +
								"<span><b>P.vụ:</b>&nbsp;.....................................</span>" +																 
								"</p>" +								 													 "</tr>" +
							"<tr>" +
								"<p style='width:100%;height:5px;text-align:center;'><b>SƠ ĐỒ XE GIƯỜNG NẰM CHẤT LƯỢNG CAO</b></p>" +
								
							"</tr>" +
							"<tr>" +
								"<p style='height:5px;'>" +							 
								"<span style='border:1px solid #000;padding-right:63px;padding-left:63px;'><b>Khu Vực Lái</b></span>" +								
								"<span style='padding-left:261px;'></span>" +							
								"<span style='border:1px solid #000;padding-right:50px;padding-left:51px;'><b>Cửa Lên Xuống</b></span>" +
								"</p>" +
							 "</tr>" +
							"<tr>" +
								"<p style='height:5px;'>" +
								"<span style='border:1px solid #000;padding-right:86px;padding-left:86px;'><b>Dãy C</b></span>" +								
								"<span style='padding-left:23px;'></span>" +							
								"<span style='border:1px solid #000;padding-right:87px;padding-left:83px;'><b>Dãy B</b></span>" +
								"<span style='padding-left:24px;'></span>" +		
								"<span style='border:1px solid #000;padding-right:83px;padding-left:85px;'><b>Dãy A</b></span>" +
								"<p>" +
							"</tr>" +
							
							"<tr>" +
								"<p style='height:5px;'>" +
								"<span style='border:1px solid #000;padding-right:19px;padding-left:19px;'><b>Tầng trên</b></span>" +
								"<span style='border:1px solid #000;padding-right:18px;padding-left:18px;'><b>Tầng dưới</b></span>" +
								"<span style='padding-left:23px;'></span>" +
								"<span style='border:1px solid #000;padding-right:18px;padding-left:18px;'><b>Tầng trên</b></span>" +
								"<span style='border:1px solid #000;padding-right:17px;padding-left:17px;'><b>Tầng dưới</b></span>" +
								"<span style='padding-left:24px;'></span>" +
								"<span style='border:1px solid #000;padding-right:18px;padding-left:18px;'><b>Tầng trên</b></span>" +
								"<span style='border:1px solid #000;padding-right:17px;padding-left:17px;'><b>Tầng dưới</b></span>" +
								"</p>" +
	             ...
	             '<table style="width:100%;height:100%;">' +
		             '<tbody>' +
		               '<tr style="height: 22px">' +
			             '<td style="width:100%"><p><span style="white-space: nowrap;overflow: hidden;width:80%">{pseat._ttPayment}</span><span class="pseat-code {data._paid}">{data.seatCode}</span><p></td>' +
			             '<td></td>' +
		               '</tr>' +
		                '<tr>' +
					 '<td colspan="2" style="text-align: center;font-size: 15px;">{pseat._cname}{pseat._nTicketPerTrip}</td>' +
		                '</tr>' +
					   // '<tr>' +
			             // '<td style="font-size:small;" colspan=2><p style="white-space: nowrap;overflow: hidden;"><b>TT:</b>&nbsp;{pseat._ttPayment}</p></td>' +
		               // '</tr>' +
					    '<tr>' +
			             '<td style="font-size:small;" colspan=2><p style="white-space: nowrap;overflow: hidden;">Đ: {pseat._pInfo}</p></td>' +
		               '</tr>' +
		              // // '<tr>' +
    ...
    _itsfTpl: "<tr class='{seat._class}' data-ids='{seat._tids}' data-pdate='{seat._pdate}' data-seatinfos='{seat._seatInfos}' data-tText='{seat._pText}'>" +
        ...
        _pSNoteInfo: {
            43: {
                1: "<div style='position:relative;clear:both;margin-left:450px;'>" +
                        "<table cellpadding='0' cellspacing='0' border='0' width='250px' style='position:absolute;margin-top:-99px;'>" +
                            "<tr>" +
                                "<td style='line-height:30px;'><b>KH tại bến:</b>.......................................<b></td>" +
                            "</tr>" +
                            "<tr>" +
                                "<td style='line-height:30px;'><b>KH đón d.đường:</b>.............................<b></td>" +
                            "</tr>" +
                           "<tr>" +
                                "<td style='line-height:30px;'><b>Tổng Cộng:</b>.......................................<b></td>" +
                            "</tr>" +
                                        "</tbody>" +
                                    "</table>" +
                                "</td>" +
