//Extend dict
define({
        _pStyleUrl: "/Comp/1402/print.css?v=1.0.1",	  
        _hasDriverTrip: true,
        _pSpecialPos: {
        50: {
            "1_8_2": [1, 6, 2], "1_8_4": [1, 6, 4],
            "2_8_2": [2, 6, 2], "2_8_4": [2, 6, 4]
        }
    },
	
	_hasMergeTransfer: { 24222: true, 24223: true },
    _hasTransferTimeConf: ["00:00-23:59"],
	   ...
	   _sTpl: "<li class='seat {seat._notallow} {seat._half}' data-ticket-code='{seat._code}' data-position='{seat._coach}_{seat._row}_{seat._col}'><div class='{seat._class}'><div class='clearfix'><div class='seat-code'>{seat._label}</div><div class='pick'>{seat._pInfo}</div></div>"
            + "<div class='agentinfo clearfix'><p>{seat._suser}{seat._cuser}</p><p><b>{seat._note}</b> {seat._fare}</p><p class='cinfo'><span class='name'>{seat._cname}<span class='numT'>{seat._nTicketPerTrip}</span><span class='phone'>&nbsp;&nbsp;{seat._cphone}</p></div><div class='clearfix'><div class='buttons'>{seat.buttons}<p class='pmInfo'>{seat._pmInfo}</p></div></div></div></li>",

        	//block ghế theo biển số xe
		_blockSeatByVehicle: ["1|6|1","1|6|3","1|6|5","1|7|1","1|7|2","1|7|3","1|7|4","1|7|5",
							  "2|6|1","2|6|3","2|6|5","2|7|3","2|7|4"],
							   //c11, b11, a11, c13, c15, b13, b15, A13, c12, b12, a12, b14, b16
		//Mở khoá theo xe
		_unblockSeatByVehicle: 
		{
				
				"81B-000.01": ["1|6|5","1|7|1","1|7|2","1|7|5","2|6|5"],
				"81B-003.86": ["1|6|5","1|7|1","1|7|2","1|7|5","2|6|5"],
				"81B-003.47": ["1|7|1","1|7|2","1|7|3","1|7|4","1|7|5","2|7|3","2|7|4"],
				"81B-007.54": ["1|6|1","1|6|3","1|6|5","2|6|1","2|6|3","2|6|5","2|7|3","2|7|4"],
				"81B-007.76": ["1|6|1","1|6|3","1|6|5","2|6|1","2|6|3","2|6|5","2|7|3","2|7|4"],
				"81B-010.45": ["1|6|1","1|6|5","1|7|1","1|7|2","1|7|3","1|7|4","1|7|5","2|6|1","2|6|5","2|7|3","2|7|4"]					  
		},
		_pTplNumCoach: 1,
        _pTplNumCol: 5,
		_pNoSeat: true,
   ...
   // _allowGroupByCode: true,
    ...
    _psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
            + "<tbody>"
           + "<tr style='height: 18px;'><td><p><span class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</span></p><p class='gia' style='float:right; text-align:right;'><span class='fare'><b>{pseat._fare}</b></span>&nbsp;&nbsp;<span class='ntk-pertrip'><b>{pseat._nTicketPerTrip}</b></span></p></td></tr>"
            + "<tr><td><p style='margin-top: -3px;'><span class='pcname'>{pseat._cname}</span><span class='pcphone'>{pseat._cphone}</span></p></td></tr>"
			+ "<tr><td><p class='pmInfo'>{pseat._pInfo}</p><p class='pnote'><b>{pseat._note}</b></p></td></tr>"
           + "</tbody>"
            + "</table></li>",
