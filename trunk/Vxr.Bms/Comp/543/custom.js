...
define({
    ...
    _noBackground: true,
    _sTpl: "<li class='seat {seat._notallow} {seat._half}' data-ticket-code='{seat._code}' data-position='{seat._coach}_{seat._row}_{seat._col}'><div class='{seat._class}'><div class='clearfix'><div class='seat-code'>{seat._label}</div><div class='pick' style='font-size:12px !important;'>{seat._pInfo}</div></div>"
    ...
    //_blockSeatByVehicle: ["2|6|1", "2|6|3", "2|6|5", "1|6|2", "1|6|4"],
    //Mở khoá theo xe
    // _unblockSeatByVehicle:
    // {
        // "79B-005.87": ["1|6|2", "1|6|4"],
        // "79B-006.20": ["1|6|2", "1|6|4"],
        // "79B-012.32": ["2|6|1", "2|6|3", "2|6|5"]
    // },
    _eTicket: {
	...
	,
            ...
            "custom": {
				9506: {
                    "sm": "<div style='width:330px; margin: 0 auto; padding-left: 20px;'><div class='col-xs-12 logonx' style='padding: 0;font-weight: 700;font-size: 35px;text-align:center;font-family:-webkit-body;'>GIA PHÚC</div>"                        
                        + "<div class='row' style='margin-top:20px;margin-bottom:5px;clear:both;style='margin-left:0 !important;margin-right:0 !important;''><div class='col-xs-12'>"
                            + "<div style='float:left;width:100%;'>"
                                + "<div style='float:left;width:30%;font-weight:bold;font-size:20px !important;'>Hồ Chí Minh</div>"
                                + "<div style='float:right;width:70%;font-size:20px !important;'>258A Lê Hồng Phong, P.4, Q5</br>08.6686.1197  0583.50.86.86</br></div>"
                            + "</div>"
                             + "<div style='float:left;width:100%;'>"
                                 + "<div style='float:left;width:30%;font-weight:bold;font-size:20px !important;'>Cam Ranh</div>"
                                 + "<div style='float:right;width:70%;font-size:20px !important;'>2108 Đại Lộ Hùng Vương</br>Tp Cam Ranh</br>0583.956.957  0583.955.555</br></div>"
                             + "</div>"
							 // + "<div style='float:left;width:100%;'>"
                                 // + "<div style='float:left;width:30%;font-weight:bold;font-size:25px !important;'>Hotline</div>"
                                 // + "<div style='float:right;width:70%;font-size:25px !important;'>09777.99.777</br></div>"
                             // + "</div>"
                        + "</div></div>"
                       ...
                       // + "<h5 style='margin-bottom:5px;'><span style='text-transform:uppercase;font-weight:bold;'>{ticket._toArea}</span></h5>"
                        ...
                        + "<p style='margin-bottom:0;'>Ngày đi: <span style='text-decoration:underline;font-size:25px !important;'>{ticket._tripDate}</span></p>"
                        ...
                        + "<hr style='border:1px #000 solid; margin:0'/><div class='row' style='padding-bottom:100px;margin-left:0 !important;margin-right:0 !important;'><div class='col-xs-12'><h5 style='text-transform: uppercase;'><b><span style='font-size: 30px;'>{ticket._cname}</span></b> &nbsp; {ticket._cphone}</h5>"
