//Extend dict
define({
    _pStyleUrl: "/Comp/582/print.css?v=1.0.31",
    ...
    // _unblockSeatByVehicle:
        // {
            ...
            // "79B-013.24": ["1|6|1", "2|6|1"],
			// "51B-122.22": ["1|6|1", "2|6|1"],
            // "79B-1412": ["1|6|1", "2|6|1"],
			// "79B-1571": ["1|6|1", "2|6|1"]
    ...
    /* Pick up */
    //_puTpl: "<div class='plist'><h4>DANH SÁCH ĐÓN DỌC ĐƯỜNG&nbsp;<small>chuyến {t._timeSlots}</small></h4><table class='table table-bordered table-responsive list-ticket'><thead><tr class='bg-primary'><th class='col-md-1 hidden-xs'>STT</th><th>Địa chỉ đón</th><th>Số ghế</th><th>Số điện thoại</th><th class='hidden-xs'>Tổng tiền</th><th class='hidden-xs'>Trạng thái</th><th class='hidden-xs' style='width:200px;'>Ghi chú</th></tr></thead><tbody></tbody><tfoot class='hidden-xs'><tr><td colspan='5' style='text-align: right;'>Tổng cộng</td><td><strong class='vred'>{t._total}</strong></td><td colspan='2'>&nbsp;</td></tr><tr><td colspan='8'><button class='btn btn-sm btn-success btn-order'>Lưu sắp xếp</button>&nbsp;<button class='btn btn-sm btn-warning btn-print-list'><i class='glyphicon glyphicon-print'></i>&nbsp;In danh sách</button></td></tr></tfoot></table></div>",
    ...
    _ppuTpl: "<div class='list plist'><h4 style='text-align: center;'>DANH SÁCH ĐÓN DỌC ĐƯỜNG</h4><table class='table table-bordered'><thead><tr style='width:100% !important;'><th  style='width:30% !important;'>Địa chỉ đón</th><th style='width:20% !important;'>Số ghế</th><th style='width:14% !important;'>SĐT</th><th style='width:12% !important;'>Tổng tiền</th><th style='width:12% !important;'>T.thái</th><th style='width:15% !important;'>Ghi chú</th></tr></thead><tbody></tbody><tfoot><tr><td colspan='1' style='text-align: right; padding-right: 5px;'>Tổng cộng</td><td>{t._totalSeat}</td><td colspan='1'></td><td><strong>{t._total}</strong></td><td colspan='2'>&nbsp;</td></tr></tfoot></table></div>",
    _ippuTpl: "<tr><td>{seat._pText}</td><td style='width:70px !important;'>{seat._seatCodes}</td><td>{seat._cphone}</td><td><strong>{seat._total}</strong></td><td style='width:100px !important;'>{seat._status}</td><td style='width:200px !important;'>{seat._note}</td></tr>",
