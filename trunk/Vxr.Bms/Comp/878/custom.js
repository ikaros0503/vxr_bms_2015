...
define({
    ...
    _ipcLTpl: "<tr class='{seat._class}'><td>{seat._index}</td><td>{seat._cname}&nbsp;<span class='numT'>{seat._nTicketPerTrip}</span></td><td>{seat._cphone}</td><td>{seat._fromStop.Name}</td><td>{seat._toStop.Name}</td></tr>",
    ...
    _fromToBaseId: [24, 23, 54, 42, 40, 56, 41, 25, 46, 50, 47, 48],
