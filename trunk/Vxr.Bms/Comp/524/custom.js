...
define({
	_specialPos: {
			 48: {
                 "1_7_5": [1, 7, 1], "1_7_4": [1, 7, 2], "1_7_2": [1, 7, 4], "1_7_1": [1, 7, 5],
				 "2_7_5": [2, 7, 1], "2_7_4": [2, 7, 2], "2_7_2": [2, 7, 4], "2_7_1": [2, 7, 5]
             }
	...
	_psTpl: "<li class='print-seat'><table class='table no-border table-condensed'>"
             + "<tbody>"
            + "<tr style='height: 18px;'><td><p class='pseat-code {pseat._dathanhtoan}'>{pseat._label}</p><p class='fare'>{pseat._fare}</p><p class='stage'>{pseat._stageName}</p></td></tr>"
            + "<tr><td><p class='pcname'>{pseat._cname}&nbsp;<span class='ntk-pertrip'><b>{pseat._nTicketPerTrip}</b></span></p><p class='phone'><b>{pseat._cphone}</b></p></td></tr>"
			+ "<tr><td><p class='pnote'>{pseat._note}</p></td></tr>"
            + "</tbody>"
             + "</table></li>",
