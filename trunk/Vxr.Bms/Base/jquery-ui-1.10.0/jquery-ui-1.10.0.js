...
$.extend(Datepicker.prototype, {
	...
	parseDate: function (format, value, settings) {
		...
		var iFormat, dim, extra,
			...
			getName = function(match, name, longNames) {
				var index = -1,
					names = $.map(lookAhead(match) ? longNames : name, function (v, k) {
						return [ [k, v] ];
					}).sort(function (a, b) {
	...
	formatDate: function (format, date, settings) {
		...
		var iFormat,
			...
			formatName = function (match, value, names, longNames) {
			    return (lookAhead(match) ? longNames[value] : names[value]);
			},
			output = "",
			literal = false;
