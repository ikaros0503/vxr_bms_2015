...
var jHtml = {
    ...
    largeResultHtml:
        '<div class="largeResult">' +
            '<span>Dữ liệu quá nhiều, vui lòng xem <a target="_blank" href={link}>file Excel</a><span> <br />' +
        '</div>',
...
var rFromToTripOfficeStaffStatus = {
    _v: ['Từ', 'Đến', '', '', '', ''],
    _e: ['From', 'To', 'Trip', 'Office', 'Staff', 'Status'],
    _d: ['input,3,,,,,1,fromdate', 'input,3,,,,,1,todate', 'select,1,,getRoute,route,,1,route', 'select,1,,getBranchEmployer,agent~user,,1,agent', 'select,1,,getUser,user~agent,,1,user', 'select,1,,getStatus,status,,1,status']
};
...
var opt = {
    ...
    listReport: [
        ...
        { id: 2, name: 'Số tiền nhân viên thu được hàng ngày', index: 2, value: 'rpStaffBySoldDate', filter: rFromToTripOfficeStaff, typereport: '0,1,2,3,4', rightId: $.rights.rRp2.val },
        { id: 3, name: 'Số tiền nv thu tính theo ngày khởi hành', index: 3, value: 'rpStaffByPickupDate', filter: rFromToTripOfficeStaff, typereport: '0,1,2,3,4', rightId: $.rights.rRp3.val },
        { id: 4, name: 'Số tiền VP/đại lý thu được hàng ngày', index: 4, value: 'rpAgentOrBranchBySoldDate', filter: rFromToTripOffice, typereport: '0,1,2,3', rightId: $.rights.rRp4.val },
        { id: 5, name: 'Số tiền VP/Đại lý thu tính theo ngày khởi hành', index: 5, value: 'rpAgentOrBranchByPickupDate', filter: rFromToTripOffice, typereport: '0,1,2,3', rightId: $.rights.rRp5.val },
        { id: 6, name: 'Số tiền thu tính theo chuyến', index: 6, value: 'rpRevenueByTrip', filter: rRevenueByTrip, typereport: '0,1,2', rightId: $.rights.rRp6.val },
        { id: 7, name: 'Số tiền thu tính theo tuyến', index: 7, value: 'rpRevenueByRoute', filter: rRevenueByRoute, typereport: '0,1,2', rightId: $.rights.rRp7.val },
        { id: 8, name: 'Số tiền VP/Đại lý thu tính theo tuyến', index: 8, value: 'rpBranchByRoute', filter: rFromToTripOffice, typereport: '0,1,2,3', rightId: $.rights.rRp8.val },
        ...
        //{ id: 12, name: 'Doanh thu nhân viên theo người đặt', index: 12, value: 'rpRevenueByCreatedUser', filter: rFromToTripOfficeStaffStatus, typereport: '0,1,2,3,4,5', rightId: $.rights.rRp12.val},
        // báo cáo số 13 dành cho nhà xe 5 Rùm
        //{ id: 13, name: 'Số tiền thu tính theo chuyến', index: 13, value: 'rpRevenueByTrip5Rum', filter: rRevenueByTrip, typereport: '0,1,2', rightId: $.rights.rRp61.val }
    ],
    wReport: 1,
...
var helps = [
    ...
    //{ id: 13, ex: "Báo Cáo giúp nhà xe có thể kiểm tra ở từng chi nhánh/đại lý khác nhau đã bán được bao nhiêu vé chuyến đó và xem doanh thu của chuyến trong cùng ngày và giờ khởi hành" }
];
