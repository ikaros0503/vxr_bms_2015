define({
    ...
    _reloadBks: function (o) {
        ...
        if (jQuery.isEmptyObject(app.oldData) && o.data != undefined && history.state != 'data') {
            app.oldData.t = o.data.t;
            app.oldData.d = o.data.d;
            app.oldData.h = o.data.h;
        }
        //if (o.data == undefined)
        //    o.data = app.oldData;
        ...
        *************************************************************************/
        _fakeBookedSeat: function (sp, s) {
            ...
            var seat = {
                ...
                _suser: "B:&nbsp;" + app.un,
                _pmInfo: " - " + app.aice,
                _fromStop: { Id: "", Type: "", Code: "", Name: "" },
                _toStop: { Id: "", Type: "", Code: "", Name: "" },
