define({
    ...
    _bindEventOnQuickBookForm: function (tData) {
        ...
        me._$qBkMd.find('button.print-qBook').unbind().on('click', function (e) {
            ...
            me._payQBook(tData, afterSave, true);
        });
    },
    _payQBook: function (tData, afterSave, isPrintETicket) {
        var me = this;
        var obj = me._createPayQBookObj(tData, isPrintETicket);
        if (false != obj) {
    ...
    _createPayQBookObj: function (tData, isPrintETicket) {
        var me = this;
