...
define({
    start: function (o) {
        var me = this;
        vbv('doGetSuggestPickup', function (e) { // do get suggest pickup
            if (e.d) {
                me._suggestLocations(e.d.f, e.d.lpp, e.d.key, e.d.tTime);
            }
        });
        vbv('doNavigateSuggestPickup', function (e) { // navigate through suggest pickup result
            if (e.d) {
                me._navigateSuggestPickupResult(e.d.keyCode);
            }
        });
    },
    _suggestLocations: function (f, lpp, key, tTime) {
        var me = this;
        if (lpp == null) return;
        var strs = lpp.split('~');
        ...
        var $input = f.find('input[name=PickupInfo]');
    ...
    _bindEventsOnSearchResult: function (f) {
        $('div.search-result tr').mousedown(function () {
            if ($("input:text[name=PickupInfo]").is(":focus")) {
    ...
    _navigateSuggestPickupResult: function (key) {
