define({
    title: 'Quản lý hướng dẫn viên', name: 'Hướng dẫn viên',
    grid: true, gTitle: 'Danh sách hướng dẫn viên', gId: 'guideTableContainer', //gRights: 41,
    xWidth: '', cols: 4, winCls: 'huongdanvien', useSmCls: true, autoClear: true,
    ...
    queryConditions: (app.cid == app.vid) ?
        {
            IsPrgStatus: 1, Type: "$x=5 order by IsPrgUpdatedDate desc"
        } :
        {
            CompId: app.cid,
            IsPrgStatus: 1,
            Type: "$x=5 order by IsPrgUpdatedDate desc"
        },
    defaultData: { Type: 5, IsPrgStatus: 1, CompId: app.cid },
    ...
    items: [
         ...
         },
        {
        ...
        },
         {
             ...
             form: true, fIdx: 5, cls: 'gender', rights: '', cbb: true,
    ...
    buttons: [
        ...
        },
        {
            ...
            messSucc: 'Xóa hướng dẫn viên thành công.',
