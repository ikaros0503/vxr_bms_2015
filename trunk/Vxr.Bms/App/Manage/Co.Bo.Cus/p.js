define({
    ...
    init:function(){
        ...
        var filter = {
            ...
            fromDate: moment(new Date()).day(0).format("YYYY-MM-DD"),
            names: [],
            phones: [],
            email: [],
    ...
    updateFilter:function(){
        ...
        if (timeRange == "custom") {
            ...
            me.settings.filter.fromDate = moment([new Date().getFullYear(), new Date().getMonth()]).format("YYYY-MM-DD");
        } else if (timeRange == "week") {
            me.settings.filter.toDate = moment(new Date()).format("YYYY-MM-DD");
            me.settings.filter.fromDate = moment(new Date()).day(0).format("YYYY-MM-DD");
        }
        else if (timeRange == "year") {
            me.settings.filter.toDate = moment(new Date()).format("YYYY-MM-DD");
            me.settings.filter.fromDate = moment([new Date().getFullYear()]).format("YYYY-MM-DD");
        }
