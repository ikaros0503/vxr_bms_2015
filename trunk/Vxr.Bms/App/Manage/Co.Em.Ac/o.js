define({
    ...
    items: [
        ...
        },
        {
            ...
            grid: true, gIdx: 3, gQuery: true, eCls: 'dupInfo', eLabel: 'Duplicate Rights',
            options: [
        ...
        },
        {
            ...
            grid: false, gIdx: 6, gQuery: true, noSave: true,
        },
        {
            xtype: 'combobox', name: 'PersonFullName', label: 'Tên nhân viên', data: true,
            form: false, fIdx: 5, cls: 'role', rights: '', cbb: true,
            grid: false, gIdx: 7, gQuery: true, noSave: true
        },
        {
        ...
        },
        {
            ...
            grid: true, gIdx: 4, gQuery: true, rvc: "rvcInfo", svc: "svcInfo", gDis: 'gDisInfo'
        },
        {
            xtype: 'combobox', name: 'TripId', cbb: true, ref: '.trip-id', data: true,
            label: "Tuyến mặc định", form: true, cls: 'trip-id', rights: '', options: [],
            grid: true, gQuery: false, fIdx: 7, gIdx: 8, noSave: true,
            gDis: 'gDisTripId',
            listConfig: {
        ...
        {
            xtype: 'checkboxActive', name: 'IsPrgStatus', label: 'Khóa tài khoản', value: '1', ref: 'input.deactivate',
            //form: true, fIdx: 9, cls: 'deactivate', data: true, rights: $.rights.deaccount.dtr,
            form: true, fIdx: 9, cls: 'deactivate', data: true, rights: '', grid: true,
            options: [{ Id: 1, Name: '' }, { Id: 3, Name: 'Đã khóa' }, { Id: null, Name: '' }],
            gIdx: 5, gQuery: true, svc: "svcactive", rvc: "rvcactive", auto: true, gDis: 'gIsPrgStatus',
            listeners: [{ xClick: 'gDeactivate' }]
        },
        {
