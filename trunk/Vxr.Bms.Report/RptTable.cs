    ...
    public class RptTable
    {
                                                ...
                                                if ((this.SubRowSumGobal != null) && (this.SubRowSumGobal.posFunc != null))
                                                {
                                                    ...
                                                    for (int m = 2; m < this.cCols; m++)
                                                    {
                                                        if (this.SubRowSumGobal.posFunc[m] > 0)
                                                        {
                                                            ...
                                                            table.Append("<td class=\"" + "warning-sub-total " + this.mArrRightStyleCss[m] + "\">" + input + "</td>");
                                                        }
                                                        ...
                                                        {
                                                            table.Append("<td class=\"" + "warning-sub-total " + "\">&nbsp;</td>");
                                                        }
                                                    }
                                                    table.Append("</tr>");
                                                }
                                        ...
                                        if ((this.SubRowSumGobal != null) && (this.SubRowSumGobal.posFunc != null))
                                        {
                                            ...
                                            for (int m = 2; m < this.cCols; m++)
                                            {
                                                if (this.SubRowSumGobal.posFunc[m] > 0)
                                                {
                                                    ...
                                                    table.Append("<td class=\"" + "success-sub-sub-total " + this.mArrRightStyleCss[m] + "\">" + input + "</td>");
                                                }
                                                else if (this.SubRowSumGobal.position == m)
                                                {
                                                    if (mColMergForSubSumRowSub > 0)
                                                ...
                                                {
                                                    table.Append("<td class=\"" + "success-sub-sub-total" + "\">&nbsp;</td>");
                                                }
                                            }
                                            table.Append("</tr>");
                                        }
                                ...
                                if ((this.SubRowSumGobal != null) && (this.SubRowSumGobal.posFunc != null))
                                {
                                    ...
                                    for (int m = 2; m < this.cCols; m++)
                                    {
                                        if (this.SubRowSumGobal.posFunc[m] > 0)
                                        {
                                            ...
                                            table.Append("<td class=\"" + this.SubRowSumGobal.cssClass + " " + this.mArrRightStyleCss[m] + "\">" + input + "</td>");
                                        }
                                        else if (this.SubRowSumGobal.position == m)
                                        {
        ...
        public void AddParentMakup(ref StringBuilder table, RptItem item, int cCountCols, object[] a, int[] arrPos, int curIndex, bool bAddSubSub)
        {
            ...
            if (bAddSubSub)
            {
                ...
                str = "<td class=\"rptTD text-center \" rowspan=" + offset.ToString() + ">";
            }
                    ...
                    ((item.list[0].list[0].list.Count != 0) && item.list[0].list[0].list.Count > 1)))))
            {
                ...
                str = "<td class=\"rptTD text-center \" rowspan=" + ((item.arrIndexData.Count + item.list.Count + offset)).ToString() + ">";
            }
            table.Append(str);
        ...
        public void BuidlASimpleByDB(RptTable table, string tblName, string tblGobal, string reportId, string cid)
        {
            string query;
            string extendQuery = " and CompId is null";
            if (cid != "")
            {
                extendQuery = " and CompId=" + cid;
            }
            query = "SELECT * FROM " + tblGobal + " WHERE     ReportId = " + reportId + extendQuery + " and isShow='isShow' ORDER BY OrderCol ";
            ...
            if ((item.strShowName != "IsEmpty") && (item.arrArgSumary.Count > 0))
            {
                ...
                for (int i = 0; i < this.cCols; i++)
                {
                    if (item.arrArgSumary[i] > 0)
                    {
                        ...
                        builder.Append(" ");
                        builder.Append(this.mArrRightStyleCss[i]);
                        builder.Append("\">");
                        builder.Append(str);
                        builder.Append("</td>");
                    }
